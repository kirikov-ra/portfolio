...
const UI = {
    ...
    logoContainer: "flex gap-2 w-fit",
    wrapperContainer: "bg-gray-500 rounded-full size-11 flex justify-center items-center",
    ...
    quickCommands: " mt-2 rounded-[10px] flex gap-2 sm:gap-5 py-2 min-w-0 w-full overflow-x-auto scrollbar scrollbar-track-transparent scrollbar-thumb-white/10",
                ...
                <div className={UI.rightPanel}>
                    <div className={UI.header}>
                        <div className={UI.logoContainer}>
                            <div className={UI.wrapperContainer}>
